...
function loadAndRun($ctrlName, $action) {
    ...
    $map = [
        ...
        'client_api' => ['file' => __DIR__.'/src/control/ClientApiController.php', 'class'=>'ClientApiController'],
        'tokens_api' => ['file' => __DIR__.'/src/control/TokenApiController.php', 'class'=>'TokenApiController']
    ];
